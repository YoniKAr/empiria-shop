 ...
 * event page. Deep-links to /checkout/[eventId]/seats?qty=N so the seat
 * page skips its quantity step and opens the map locked to N seats.
 */
export default function SeatQuantityCTA({ eventId, maxQuantity }: SeatQuantityCTAProps) {
